...
/**
 * Trilha de auditoria - requisito FUNCIONAL, nao apenas tecnico (secao 16 do
 * Contexto Tecnico). Registra o antes e o depois de toda alteracao relevante.
 */
export const auditoria = pgTable('auditoria', {
  ...
  /** CRIACAO | ALTERACAO | EXCLUSAO | LOGIN | LIBERACAO */
